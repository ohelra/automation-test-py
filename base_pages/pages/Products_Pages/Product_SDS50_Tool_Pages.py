...
class ProductSDS50ToolPage(RSPROHomePage):

    product =                          (By.ID, "navbarDropdown")
    title_sgw =                        (By.ID, "_articleTitle")
    napa_auto_parts =                  (By.ID, "SDS50FindinstoreNP")
    o_reilly_auto_parts =              (By.ID, "SDS50FindinstoreOR")
    auto_zone =                        (By.ID, "SDS50FindinstoreAZ")
    sds50_tool =                       (By.XPATH, "(//a[contains(text(),'SDS50')])[1]")
    title_sds50 =                      (By.XPATH, "(//span[normalize-space()='Innova SDS50'])[1]")
    ...
    def get_thumbnail_count_sds50(self):
        return len(self.driver.find_elements(*self.thumbnail_images))

    def get_image_src_sds50(self):
    ...
    def click_thumbnail_by_index_sds50(self, index):
        slide_locator = (
            By.CSS_SELECTOR,
    ...
    def click_complete_specs_feature_list_sds50(self):
    ...
    def scroll_to_video_sds50(self):
        self.scroll_to(self.main_video_iframe)

    def play_main_youtube_video_sds50(self):
        time.sleep(1.5)
